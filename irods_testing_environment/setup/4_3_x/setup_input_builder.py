class setup_input_builder(setup_input_builder):
    """Builder for iRODS 4.3.x setup script inputs.
    ...
    def __init__(self):
        ...
        """
        super(setup_input_builder_4_3_x, self).__init__()

        self.service_account_name = ''
        self.service_account_group = ''
        self.catalog_service_role = ''

        self.has_local_storage = 'y'
    ...
    def setup(self, **kwargs):
        ...
        self.has_local_storage = kwargs.get(has_local_storage, self.has_local_storage)
        self.default_resource_name = kwargs.get(default_resource_name, self.default_resource_name)
    ...
    def build_input_for_catalog_consumer(self):
        ...
        input_text.append(str(self.service_account_name))
        input_text.append(str(self.service_account_group))
        input_text.append(str(role))

        input_text.append(str(self.has_local_storage))
        if self.has_local_storage:
            input_text.append(str(self.default_resource_name))

        input_text.append(str(self.zone_name))
        input_text.append(str(self.catalog_service_provider_host))
        input_text.append(str(self.zone_port))
        input_text.append(str(self.parallel_port_range_begin))
        input_text.append(str(self.parallel_port_range_end))
        input_text.append(str(self.control_plane_port))
        input_text.append(str(self.schema_validation_base_uri))
        input_text.append(str(self.admin_username))
        input_text.append('y') # confirmation of inputs

        input_text.append(str(self.zone_key))
        input_text.append(str(self.negotiation_key))
        input_text.append(str(self.control_plane_key))
        input_text.append(str(self.admin_password))
        input_text.append('') # confirmation of inputs

        input_text.append(str(self.vault_directory))
        input_text.append('') # confirmation of inputs
    ...
    def build_input_for_catalog_provider(self):
        ...
        input_text.append(str(self.odbc_driver))
        input_text.append(str(self.database_server_hostname))
        input_text.append(str(self.database_server_port))
        input_text.append(str(self.database_name))
        input_text.append(str(self.database_username))
        input_text.append('y') # confirmation of inputs
        input_text.append(str(self.database_password))
        input_text.append(str(self.stored_passwords_salt))
